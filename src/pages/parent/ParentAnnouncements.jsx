...
const ParentAnnouncements = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      setLoading(true);
      const data = await AnnouncementService.getAnnouncementsForParent();
  ...
  const formatDate = (dateString) => {
    console.log('ParentAnnouncements formatDate called with:', dateString, 'type:', typeof dateString);
    
    if (!dateString) {
      console.log('ParentAnnouncements: No dateString provided, returning empty');
      return '';
    }
    ...
    if (typeof dateString === 'string') {
      console.log('ParentAnnouncements: Processing string date:', dateString);
      // Replace space with 'T' if needed for ISO format
      const isoString = dateString.replace(' ', 'T');
      console.log('ParentAnnouncements: ISO string:', isoString);
      date = new Date(isoString);
    } else if (Array.isArray(dateString)) {
      console.log('ParentAnnouncements: Date is array format:', dateString);
      ...
      console.log('ParentAnnouncements: Processing non-string date:', dateString);
      date = new Date(dateString);
    }
    
    console.log('ParentAnnouncements: Parsed date object:', date);
    
    // Check if date is valid
    if (isNaN(date.getTime())) {
      console.warn('ParentAnnouncements: Invalid date after parsing:', dateString, 'resulted in:', date);
    ...
    console.log('ParentAnnouncements: Formatted date:', formatted);
    return formatted;
  };
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Xem các thông báo mới nhất từ nhà trường dành cho phụ huynh
        </p>
      </div>
