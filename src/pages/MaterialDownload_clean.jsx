  ...
  useEffect(() => {
    const mockMaterials = [
      ...
      },
      {
        ...
        description: 'Detailed requirements for the semester project'
      },
      {
        id: 4,
        title: 'Code Examples Archive',
      ...
      },
      {
        ...
        description: 'Various UML diagram examples for reference'
      }
    ];

    // For demo purposes, use mock data with loading simulation
    setTimeout(() => {
  ...
  const handleDownload = async (material) => {
    try {
      ...
      for (let i = 0; i <= 100; i += 10) {
        ...
        setDownloadProgress(prev => ({ ...prev, [material.id]: i }));
      }
