    ...
    try {
        ...
        uploadTask.on(
            ...
            (error) => {
                ...
                // If CORS error, fallback to backend upload
                if (error.code === 'storage/unauthorized' || error.message.includes('CORS')) {
                    console.log('[Debug] CORS error detected, falling back to backend upload');
                    message.warning('Đang thử phương thức upload khác...');
